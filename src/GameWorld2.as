package
{
	...
	public class GameWorld2 extends World
	{
		...
		[Embed(source = '../assets/gfx/default_alt.txt', mimeType = 'application/octet-stream')]	public var LEVEL:Class;
		[Embed(source='../assets/gfx/empty_tiles.png')]		public var TILES:Class;	
